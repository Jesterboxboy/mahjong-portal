...
# Email: custom backend persists every sent message to the SentEmail model (admin-viewable)
EMAIL_BACKEND = "mahjong_portal.email_backend.DBLoggingEmailBackend"
